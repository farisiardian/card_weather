...
function App() {
  return (
    <>
      <div className="weather flex min-h-[10em] min-w-[16em] flex-col items-center justify-center gap-[0.5em] rounded-[1.5em] bg-[#3D73DD] px-[1em] py-[0.5em] font-nunito text-[#FFFFFF] shadow-[0px_4px_16px_0px_#222]">
        <div className="flex h-fit w-full items-center justify-center gap-[1em]">
          ...
          <span className="h-[4em] w-[1px] rounded-full bg-[hsla(336,86%,70%,0.5)]"></span>
        ...
        <div className="h-[0.5px] w-full rounded-full bg-[hsla(336,86%,70%,0.5)]"></div>
        <div className="flex h-fit w-full items-center justify-between">
          <div className="flex h-fit w-full flex-col items-start justify-between text-[0.75em]">
            <div className="flex flex-row items-center justify-center gap-[0.5em] p-[0.25em]">
              ...
              <span className="h-[0.5em] w-[1px] rounded-full bg-[hsla(336,86%,70%,0.5)]"></span>
              <p>Wind Speed</p>
              <span className="h-[0.5em] w-[1px] rounded-full bg-[hsla(336,86%,70%,0.5)]"></span>
              <p>11km/hr</p>
            </div>
